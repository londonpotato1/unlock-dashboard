...
const unlocks = [
  ...
  },
  {
    ...
    vesting: "TGE 2025-05-08 · ZK 기반 verifiable database + AI 데이터 스택 (Microsoft·Chainlink 파트너십). 5/8 13:00 UTC = 22:00 KST cliff에 387.64M SXT 일괄 해제 (DropsTab/Tokenomist/Messari/CMC 4개 소스 일치). unlockPct 23.20%는 CMC adjusted released supply 기준 ($5.96M / 조정시총 $25.7M), Total Supply 5B 대비 7.75%, Circulating 2.6B 대비 14.9%. 사전 신호: 5/3→5/6 거래량 5.7배 폭증 ($1.19M→$6.75M), Binance OI 67%↑ ($1.39M→$2.32M, 162M tokens), 5/5 ATL $0.01402 신저점. Ecosystem & Community 단일 카테고리 cliff (Tokenomist) 또는 3개 allocation 묶음 (Messari) 해석 차이. Bithumb KRW 활성하나 top-5 depth ₩26M (~$19k)로 얕음, Upbit 미상장",
    strategy: [
      { type: "short", title: "TGE 1주년 cliff + D-2 선반영 폭증",
        desc: "5/3~5/6 거래량 5.7배·Binance OI 67% 폭증으로 단기 short positioning 확인. 387.64M SXT (유통 14.9%) Ecosystem 카테고리 일괄 해제 예정. 이미 ATL 직후라 추가 하방은 제한적이나 cliff 직후 30~60분 매도 압력 정점",
        risk: "OI $2.32M (시총 5.9%) 작아 short squeeze 위험. Bithumb thin orderbook (~$19k depth top-5)로 한국 매도 시 슬리피지 큼. 이미 RSI 30~40 oversold 영역" },
      { type: "timing", title: "5/8 13:00 UTC (22:00 KST) 직후 청산",
        desc: "이벤트 직전~직후가 매도 압력 정점. 이미 D-2 폭증 발생으로 추가 선반영 여지 작음. Cliff 후 첫 dead-cat bounce 빠르게 도래",
        risk: "5/6 종가 +5.5% (저 $0.01426 → 종 $0.01509) 반등으로 mean reversion 신호 발생 중. 짧게 끊어가야 함" },
      { type: "bounce", title: "ATL 지지 + oversold mean reversion (cliff 후)",
        desc: "5/5 ATL $0.01402 갱신 후 5/6 +5.5% 반등으로 매수자 출현 확인. Cliff 후 매도 소진되면 ZK 섹터 sympathy bounce 가능 (5/19 PYTH cliff 등 모멘텀 합류)",
        risk: "구조적 cliff (Investor/Team 12m도 5/8 동시 풀림 가능성 - Messari '3개 allocation' 표기) 시 추가 매물. 진입은 5/8 cliff 소화 후 안전. Binance/Bybit perp만 / 현물 출구 좁음" },
    ],
  },
  {
